export const narrativeAnswersTemplateDemoEn = `The people we will help are mostly:
...
This due to {{pa-disaster-type-01}} that occured on {{pa-current-disaster-time-01}}. This program will/is happen/happening in the {{pa-current-disaster-phase-01}}.`;
